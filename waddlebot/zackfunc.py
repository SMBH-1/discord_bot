...
def glad_check(p_message):
    ...
    response = requests.get(f'https://us.api.blizzard.com/profile/wow/character/{realmSlug}/{char_name}/achievements?namespace=profile-us&locale=en_US&access_token=USBuBGmUK0on2IhNmfNfLnmpv7dOessrVP')
    data = response.json()
